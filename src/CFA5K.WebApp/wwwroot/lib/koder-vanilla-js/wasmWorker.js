...
importScripts("/lib/koder-1.3.1/package/zbar.js");
importScripts("/lib/koder-1.3.1/package/browser.js");

(async () => {
    // Initialize Koder
    //const koder = await new Koder().initialize({wasmDirectory: "./node_modules/@maslick/koder"});
    const koder = await new Koder().initialize({ wasmDirectory: "/lib/koder-1.3.1/package/" });
